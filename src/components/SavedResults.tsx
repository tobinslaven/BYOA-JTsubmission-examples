...
const SavedResults: React.FC<SavedResultsProps> = ({ savedComparisons, onLoadComparison, onDeleteComparison }) => {
  ...
  const handleDeleteClick = (comparison: Comparison, event: React.MouseEvent) => {
  ...
  const handleDeleteConfirm = () => {
    if (comparisonToDelete) {
      onDeleteComparison(comparisonToDelete.id);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={(e) => handleDeleteClick(comparison, e)}
      ...
      <DeleteConfirmModal
        ...
        title={comparisonToDelete?.title || ''}
      />
    </div>
  );
};
